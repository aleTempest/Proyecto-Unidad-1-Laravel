        ...
        <form class="w-full max-w-lg" action="{{ route('sales.update', $sale->id) }}" method="POST">
            ...
            <div class="flex flex-wrap -mx-3 mb-6">
                <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                    ...
                    <input class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white" id="sale_date" type="date" name="sale_date" value="{{ $sale->sale_date }}" disabled>
                </div>
                <div class="w-full md:w-1/2 px-3">
                    <label class="dark:text-gray-400 block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2" for="IVA">
                        IVA
                    </label>
                    <input class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white" id="IVA" type="text" placeholder="Enter IVA" name="IVA" value="{{ $sale->IVA }}" disabled>
                </div>
            </div>
            <div class="flex flex-wrap -mx-3 mb-6">
